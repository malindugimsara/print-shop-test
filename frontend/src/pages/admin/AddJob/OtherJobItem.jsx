                ...
                <div className="p-6 space-y-6">
                                ...
                                {["A3", "A4", "A5", "Other"].map((s) => (
                                    <label key={s} className="flex items-center cursor-pointer p-2 rounded hover:bg-blue-50 transition">
                                        <input
                                            type="radio"
                                            name="size"
                                            className="mr-1 cursor-pointer w-4 h-4"
                    ...
                    <div className="grid grid-cols-1  gap-6">
                        ...
                        <div className="p-5 rounded-xl border border-gray-200 bg-gray-50 hover:border-[#48CAE4] transition">
                            <h2 className="font-bold text-lg mb-4 text-[#D16BA5] flex items-center">
                                📄 Cover
                            </h2>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="p-5 rounded-xl border border-gray-200 bg-gray-50">
                            <h2 className="font-bold text-lg mb-3 text-[#D16BA5] flex items-center">
                                📝 Job Description
                            </h2>
